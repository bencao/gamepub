...
//            if (Event::handle('StartShowLShaiStyles', array($this))) {
//                $this->element('link', array('rel' => 'stylesheet',
//                                             'type' => 'text/css',
//                                             'href' => theme_path('css/display.css', null) . '?version=' . SHAISHAI_VERSION,
//                                             'media' => 'screen, projection, tv'));
//                if (common_config('site', 'mobile')) {
//                    $this->element('link', array('rel' => 'stylesheet',
//                                                 'type' => 'text/css',
//                                                 'href' => theme_path('css/mobile.css', 'base') . '?version=' . SHAISHAI_VERSION,
//                                                 // TODO: "handheld" CSS for other mobile devices
//                                                 'media' => 'only screen and (max-device-width: 480px)')); // Mobile WebKit
//                }
//                $this->element('link', array('rel' => 'stylesheet',
//                                             'type' => 'text/css',
//                                             'href' => theme_path('css/print.css', 'base') . '?version=' . SHAISHAI_VERSION,
//                                             'media' => 'print'));
//                Event::handle('EndShowLShaiStyles', array($this));
//            }
//            if (Event::handle('StartShowUAStyles', array($this))) {
//                $this->comment('[if IE]><link rel="stylesheet" type="text/css" '.
//                               'href="'.theme_path('css/ie.css', 'base').'?version='.SHAISHAI_VERSION.'" /><![endif]');
//                foreach (array(6,7) as $ver) {
//                    if (file_exists(theme_file('css/ie'.$ver.'.css', 'base'))) {
//                        // Yes, IE people should be put in jail.
//                        $this->comment('[if lte IE '.$ver.']><link rel="stylesheet" type="text/css" '.
//                                       'href="'.theme_path('css/ie'.$ver.'.css', 'base').'?version='.SHAISHAI_VERSION.'" /><![endif]');
//                    }
//                }
//                $this->comment('[if IE]><link rel="stylesheet" type="text/css" '.
//                               'href="'.theme_path('css/ie.css', null).'?version='.SHAISHAI_VERSION.'" /><![endif]');
...
//    }
    ...
    function showScripts()
    {
        if (Event::handle('StartShowScripts', array($this))) {
            ...
            if (Event::handle('StartShowLShaiScripts', array($this))) {
                $this->element('script', array('type' => 'text/javascript',
                                               'src' => common_path('js/xbImportNode.js')),
                               ' ');
                $this->element('script', array('type' => 'text/javascript',
                                               'src' => common_path('js/util.js?version='.SHAISHAI_VERSION)),
                               ' ');
                // Frame-busting code to avoid clickjacking attacks.
                $this->element('script', array('type' => 'text/javascript'),
                               'if (window.top !== window.self) { window.top.location.href = window.self.location.href; }');
                Event::handle('EndShowLShaiScripts', array($this));
            }
...
//    }
    ...
    function showPrimaryNav()
    {
        ...
        if (Event::handle('StartPrimaryNav', array($this))) {
            if ($user) {
                $this->menuItem(common_local_url('home'),
                ...
                $this->menuItem(common_local_url('link'),
                                _('Link'), _('Link to other website'), false, 'nav_link');
...
//        }
     ...
     * @return nothing
     */
    function showLShaiLicense()
    {
        $this->element('dt', array('id' => 'site_LShai_license'), 'LShai software license');
        $this->elementStart('dd', null);
        if (common_config('site', 'broughtby')) {
            $instr = '**%%site.name%%** is a microblogging service brought to you by [%%site.broughtby%%](%%site.broughtbyurl%%). ';
        } else {
            $instr = '**%%site.name%%** is a microblogging service. ';
        }
        $instr .= sprintf('It runs the [LShai](http://www.lshai.com) microblogging software, version %s', SHAISHAI_VERSION);
    ...
    {
        $this->element('dt', array('id' => 'site_content_license'), 'LShai software license');
        ...
        $this->text('All '.common_config('site', 'name').' content and data are available under the ');
