...
class ResultItem
{
    ...
    function buildResult()
    {
        ...
        $this->to_user    = ($replier_profile) ?
            $replier_profile->uname : null;

        $this->from_user    = $this->profile->uname;
        ...
        $this->source = common_source_link($this->notice->source);

        $avatar = $this->profile->getAvatar(AVATAR_STREAM_SIZE);

        $this->profile_image_url = ($avatar) ?
            $avatar->displayUrl() : Avatar::defaultImage(AVATAR_STREAM_SIZE, $this->profile->id, $this->profile->sex);
