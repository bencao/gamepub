...
class AvatarsettingsAction extends SettingsAction
{
    function getViewName() {
    	return 'AvatarsettingsHTMLTemplate';
    }
    ...
    { 
        ...
        $avatar->delete();
        $avatar = $this->cur_user_profile->getAvatar(AVATAR_PROFILE_SIZE);
        $avatar->delete();
        $avatar = $this->cur_user_profile->getAvatar(AVATAR_STREAM_SIZE);
        $avatar->delete();
        $avatar = $this->cur_user_profile->getAvatar(AVATAR_MINI_SIZE);
        $avatar->delete();
