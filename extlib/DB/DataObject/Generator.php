...
$options['database'] = "mysql://shaier:shaier@localhost/shaishaidb";
$options['schema_location'] = "/tmp";
$options['class_location'] = "/tmp";
$options['db_driver'] = "MDB2";
...
class DB_DataObject_Generator extends DB_DataObject
{
    ...
    */
    ...
    function getFileNameFromTableName($table)
    {
     ...
     /**
    * Convert a column name into a method name (usually prefixed by get/set/validateXX)
    *
    * @access  public
